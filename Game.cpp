...
#ifdef __linux__
const std::string data_install_dir = "/Compactory/";
const std::string res_install_dir = "Resource/";
void Game::getResourceDir()
{
	...
	while (found != std::string::npos)
	{
		...
		std::string resDir = tmpDir + data_install_dir + res_install_dir;
...
sf::Texture& Game::loadTexture(std::string filename) {
	...
	// such as "Resource/Image/Frame.png" becomes "/path/to/rsrc_dir/Resource/Image/Frame.png"
